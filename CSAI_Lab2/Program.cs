...
Console.WriteLine($"Побудоване дерево:\n {final}\n");

Console.WriteLine($"Тестування:\n");
Console.WriteLine(final.Test("Тест #1 (очікується Успішно):", ("Час на сесію", 1.0f), ("Якість фото", "Висока"), ("Тип документа", "Паспорт (ID-картка)"), ("Освітлення", "Добре"), ("Відповідність фото", "Так")));
Console.WriteLine(final.Test("Тест #2 (очікується Невдало):", ("Час на сесію", 15.0f), ("Якість фото", "Низька"), ("Тип документа", "Водійське"), ("Освітлення", "Погане"), ("Відповідність фото", "Ні")));
Console.WriteLine(final.Test("Тест #3 (очікується перевірка):", ("Час на сесію", 2.0f), ("Якість фото", "Середня"), ("Тип документа", "Водійське"), ("Освітлення", "Погане"), ("Відповідність фото", "Так")));
Console.WriteLine(final.Test("Тест #4 (Час - поріг):", ("Час на сесію", 4.5f), ("Якість фото", "Висока"), ("Тип документа", "Паспорт (ID-картка)"), ("Освітлення", "Нерівномірне"), ("Відповідність фото", "Так")));
Console.WriteLine(final.Test("Тест #5 (Тип Інше + Ні):", ("Час на сесію", 5.0f), ("Якість фото", "Середня"), ("Тип документа", "Інше"), ("Освітлення", "Добре"), ("Відповідність фото", "Ні")));
Console.WriteLine(final.Test("Тест #6 (Найшвидший провал):", ("Час на сесію", 1.2f), ("Якість фото", "Висока"), ("Тип документа", "Паспорт (ID-картка)"), ("Освітлення", "Добре"), ("Відповідність фото", "Ні")));